...
This tool belongs to the 'profile_analysis.modules' package
and uses shared interpolation logic from profile_analysis.core.resampling_core.
...
from profile_analysis.common.resampling_core import interpolate_to_common_grid
